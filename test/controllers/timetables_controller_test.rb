...
class TimetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post timetables_url, params: { timetable: { day: @timetable.day, slot: @timetable.slot, subject_id: @timetable.subject_id } }
    end
  ...
  test "should update timetable" do
    patch timetable_url(@timetable), params: { timetable: { day: @timetable.day, slot: @timetable.slot, subject_id: @timetable.subject_id } }
